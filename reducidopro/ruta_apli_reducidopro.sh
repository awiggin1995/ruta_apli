...
export FORNMGA_DATOS=/opt/sramga/app/mga/datos/entrada
...
export STREAMP_DATOS=pedido_proveedor2
export STREAMP_ETIBATCH=/etiquetas/batch
export STREAMP_ETIONLINE=/etiquetas/online
export STREAMP_FACTURAS=/facturas
export STREAMP_MDD=mdd
export STREAMP_SAM=pedido_proveedor2
export STREAMP_TRANSPORTES=/transportes
export STREAMSERVE_ETIONLINE=/etiquetas/online
...
export SANNROT=samgabat01.san.mercadona.es
export SANNSEC=samgabat01.san.mercadona.es
...
export CHA=srv008.cc.mercadona.es
export CUADRES=srv329.cc.mercadona.es
export FALCOM=riofi04.ofidona.net
export FORNMGA=fomgabat02.for.mercadona.es
...
export INTROSCOPE=pv0gl0301.cc0.mercadona.es
export PEDTE=batch.cc.mercadona.es
export PROTIE=srv329.cc.mercadona.es
export RIBARROJA=riofi04.ofidona.net
export SGE=sge
export STREAMP=winstreams.cc.mercadona.es
export STREAMSERVE=streamserve.cc.mercadona.es
export TAVERNES=unidadk.cc.mercadona.es
export UNIDADK=unidadk.cc.mercadona.es
...
export FORV_COPIAS=pka1199.mgm.for.mercadona.es
...
export FORV_MAQ1=hp75.for.mercadona.es
export FORV_MAQ2=hp76.for.mercadona.es
...
export OPERATIVAPI=srv359.cc.mercadona.es
export OPERATIVAPI_DATOS=/opt/srv359/app/operativapi/datos/entrada
export OPERATIVAPI_INST=DONA07_OPERATIVAPI
export OPERATIVAPI_PORT=10510
...
export FORNMGA_CODIFICACION=ISO
...
export FABRICAR_CODIFICACION=ISO
export SANNSEC_CODIFICACION=ISO
export SANNROT_CODIFICACION=ISO
export OPERATIVAPI_CODIFICACION=ISO
...
export CLOUDCONTROL=pv0gl0678.cc0.mercadona.es
export CLOUDCONTROL_CODIFICACION=ISO
...
export GESTPM=tvvil0230.ccv.mercadona.com
...
export REGIS=pvviw0144.ofidona.net
